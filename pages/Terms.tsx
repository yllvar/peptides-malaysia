      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="space-y-8 text-gray-300 leading-relaxed">
          <section>
            ...
            <p>By accessing Evo Peptides, you agree to be bound by these Terms of Service. If you do not agree, you must exit the site immediately. You affirm that you are at least 18 years of age (or 21 where applicable by law).</p>
          </section>
          <section>
            <h2 className="text-xl font-bold text-white mb-4">2. Intended Use</h2>
            <p>Products sold by Evo Peptides (Evo™ Brand) are intended exclusively for in-vitro laboratory research. </p>
          ...
          <section>
            ...
            <p>Evo Peptides shall not be held liable for any damages that result from the use or misuse of our products. The purchaser assumes all responsibility for complying with local regulations regarding the possession and use of these compounds.</p>
          </section>
          <section>
